...
1. Type in the name of the folder where you will store the code and the photographs. We chose to call ours `allseeingpi`. Double click on the `allseeingpi` folder and make a note of the path to this folder (this is displayed in the bar at the top), which should be `/home/pi/allseeingpi`.
